...
plot(u10_raster, xlab="longitude", ylab="latitude", legend.args=list(text='wind speed (m/s)', side=2, line=0.5))
points(locations$longitude,locations$latitude)
dev.off()
pdf(paste0(path, "/../Plots/Data/v10.pdf"),width = 5, height = 4)
plot(v10_raster, xlab="longitude", ylab="latitude", legend.args=list(text='wind speed (m/s)', side=2, line=0.5))
points(locations$longitude,locations$latitude)
dev.off()
pdf(paste0(path, "/../Plots/Data/msl.pdf"),width = 5, height = 4)
plot(msl_raster, xlab="longitude", ylab="latitude", legend.args=list(text='pressure (Pa)', side=2, line=0.5))
points(locations$longitude,locations$latitude)
dev.off()
pdf(paste0(path, "/../Plots/Data/tide.pdf"),width = 5, height = 4)
plot(tide_raster, xlab="longitude", ylab="latitude", legend.args=list(text='tide (m)', side=2, line=0.5))
points(locations$longitude,locations$latitude)
dev.off()
